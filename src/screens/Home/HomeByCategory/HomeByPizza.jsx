    ...
    <View style={{ flex: 1, marginTop: StatusBar.currentHeight }}>
      ...
      <ScrollView>
        ...
        <View style={tw`mt-8 px-6 pb-8`}>
          <Text style={tw`font-black text-lg mb-4`}>Pizza</Text>
          {mockGrillPizza.map((grillPizza, index) => (
            <PopularCard data={grillPizza} key={index} />
          ))}
        </View>
